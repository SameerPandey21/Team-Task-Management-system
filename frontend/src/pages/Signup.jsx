    ...
    <div className="auth-container">
      <div className="auth-box">
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <h1 style={{ fontSize: '1.75rem', marginBottom: '6px' }}>Create your account</h1>
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem' }}>Start collaborating with your team today</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            ...
            <div style={{ position: 'relative' }}>
              <User size={16} style={{ position: 'absolute', left: '14px', top: '50%', transform: 'translateY(-50%)', color: 'var(--text-secondary)', pointerEvents: 'none' }} />
              <input
